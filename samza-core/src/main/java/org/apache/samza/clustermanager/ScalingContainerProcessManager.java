...
public class ScalingContainerProcessManager implements ClusterResourceManager.Callback   {
    ...
    public ScalingContainerProcessManager(Config config,
        ...
        this.containerAllocator = new ScalingContainerAllocator(clusterResourceManager, config, state);
    ...
    public void requestOneMore(){
        ...
        containerAllocator.requestResource(String.format("%06d", containerCount),ResourceRequestState.ANY_HOST);
    }
